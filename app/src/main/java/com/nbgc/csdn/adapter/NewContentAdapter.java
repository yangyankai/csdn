...
public class NewContentAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (null == convertView)
		{
			...
			{
			case News.NewsType.TITLE:
				convertView = mInflater.inflate(com.nbgc.csdnnews.R.layout.news_content_title_item, null);
				holder.mTextView = (TextView) convertView.findViewById(com.nbgc.csdnnews.R.id.text);
				break;
			case News.NewsType.SUMMARY:
				convertView = mInflater.inflate(com.nbgc.csdnnews.R.layout.news_content_summary_item, null);
				holder.mTextView = (TextView) convertView.findViewById(com.nbgc.csdnnews.R.id.text);
				break;
			case News.NewsType.CONTENT:
				convertView = mInflater.inflate(com.nbgc.csdnnews.R.layout.news_content_item, null);
				holder.mTextView = (TextView) convertView.findViewById(com.nbgc.csdnnews.R.id.text);
				break;
			case News.NewsType.IMG:
