...
public class NewsItemAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			convertView = mInflater.inflate(com.nbgc.csdnnews.R.layout.news_item_yidong, null);
			holder = new ViewHolder();

			holder.mContent = (TextView) convertView.findViewById(com.nbgc.csdnnews.R.id.id_content);
			holder.mTitle = (TextView) convertView.findViewById(com.nbgc.csdnnews.R.id.id_title);
			holder.mDate = (TextView) convertView.findViewById(com.nbgc.csdnnews.R.id.id_date);
			holder.mImg = (ImageView) convertView.findViewById(com.nbgc.csdnnews.R.id.id_newsImg);
